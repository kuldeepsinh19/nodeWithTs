...
router.post(
  "/",
  movieAuthentication.isAuthenticated,
  movieAuthentication.userRole,
  moviesValidation.insertMovieData,
...
router.put(
  ...
  movieAuthentication.isAuthenticated,
  movieAuthentication.userRole,
  moviesValidation.updateMovieData,
  movieController.updateMovieById
);
router.get(
  "/name",
  movieAuthentication.isAuthenticated,
  movieController.cinemaListByMovieName
);
router.get(
  "/seating-plan",
  movieAuthentication.isAuthenticated,
  movieController.cinemaSeatingPlan
);
router.get(
  "/top-actors",
  movieAuthentication.isAuthenticated,
  movieController.topActors
);
